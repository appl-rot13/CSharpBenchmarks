...
- **バブルソート**:  
  隣り合う要素を比較して入れ替えていく方式

- **選択ソート**:  
  最小(最大)値を探して先頭の要素と入れ替えていく方式

- **挿入ソート**:  
  ソート済の部分列に未ソートの要素を挿入していく方式

- **シェルソート**:  
  間隔が離れた要素同士で挿入ソートを行い、徐々に間隔を狭めていく方式

- **マージソート**:  
  配列を分割し、マージしながらソートしていく方式

- **ヒープソート**:  
  ヒープ構造を利用して最大(最小)値を取り出していく方式

- **クイックソート**:  
  基準値を選び、それより小さい値と大きい値に分割していく方式
